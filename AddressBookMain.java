...
public class AddressBookMain {
    ...
    private static Map<String, List<String>> stateMap = new HashMap<String, List<String>>();
    ...
    private static void selectAddressBook() throws FileNotFoundException {
        Scanner scan = new Scanner(System.in);
                ...
                while (option != 8) {
                    ...
                    switch (option) {
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            files.writeIntoFile(name,addressBook);
                            break;
                        case 8:
                            files.readFromFile();
                            break;
